...
<div class="container-fluid">
     ...
     <?php
	 session_start();
	  if($_SESSION['SESS_LAST_NAME']=="PMS")
	  {
		  include('leftbar.php');
	  }
	  else
	...
	<div class="contentheader">
			<i class="icon-table"></i> Patient Send to Pharmacy for treatement : <?php echo date("l jS F Y"); ?>
			</div>
			<ul class="breadcrumb">
      ...
      <?php 
			...
			include('connect.php');
				$result = $db->prepare("SELECT * FROM lab ORDER BY yschima_no DESC");
				$result->execute();
...
<br>
  	<div style="text-align:center;">
			Total Number of patient Send to Pharmacy :  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font><br><br>
			</div>
			...
			<?php
				...
				for($i=1; $row = $result->fetch(); $i++){
                    ...
                    <tr class="record" style="text-transform:lowercase;">
                        ...
                        <a  title="Click To Edit " rel="facebox" href="add_test_result.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Add Findings </button></a> </td>
                          </tr>
                <?php
                    }
                ?>
