...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<center><div style="font:bold 25px 'Aleo';">GEIDAM GENERAL HOSPITAL</div>
	...
	<table cellpadding="3" cellspacing="0" style="font-family: arial; font-size: 12px;text-align:left;width : 100%;">
		...
		<tr>
			<td>Hospital No. :</td>
			<td><?php echo $_GET['hospital_no']; ?></td>
		</tr>
		<tr>
			<td>Date :</td>
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				//find user details
				$diagnos_id=$_GET['id'];
				$result = $db->prepare("SELECT * FROM diagnosis WHERE diagnos_id='$diagnos_id' ");
				$result->execute();
				$row = $result->fetch();?>
